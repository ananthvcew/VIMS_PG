...
$i=1;
	...
	<tbody>
		<tr>
			...
			<td class='text-end'><b><?=(($res['count(regno)'])-566) ?></b></td>
		</tr>
		<?php
$i=1;
			foreach ($res1 as $value) {
            $i=$i+1;
					if($value['remarks']==0){
						...
						echo "<tr><td>$i</td><td>Number of Candidates Completed the Exam</td><td class='text-end'><b>".($value['count(regno)']-566)."</b></td></tr>";
