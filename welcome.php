...
{
	document.f1.action="viewquestions2.php";
	document.f1.submit();
}
function editquestion()
{
	document.f1.action="editquestion.php";
	document.f1.submit();
}
</script>
  ...
  <form name="f1" method="post" action="viewquestions2.php" enctype='multipart/form-data'>
    ...
    <div class="col-lg-2"></div>
        <div class="col-lg-4"><input type='button' class='btn btn-primary' value='Add Questions' onClick='addQues()' /></div>
            <div class="col-lg-4"><input type='button' class='btn btn-primary'  value='View Questions' onClick='viewquestion()'/></div>
                <div class="col-lg-2"><input type='button' class='btn btn-primary'  value='Edit Questions' onClick='editquestion()'/></div>
</div>
</div>
