...
$s=new DBCON();
$link=$s->linkarivu();
$sql    = "select * from  ques where subcode='".trim($scode)."' and tcode='".$ttype."' and qset='".$set."'";
//Print $sql;
	$l=$s->linkarivu();
...
print"<div class='road row'>";
	print "<div class='col-lg-12 text-center'> ".$scode." - ".$s->getsubname1($scode)."<br> Question language:  ".$ttype."<br>";
