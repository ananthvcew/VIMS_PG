<?php
	class Dbconnection {
		//Database variables to make a connection
		// public $Database_name = "vims";
		// public $Host_name = "localhost";
		// public $Database_user = "root";
		// public $Database_pass = "vcew@123";
		
		public $Database_name="vims_pg";
		public $Host_name="localhost";
		public $Database_user="root";
		public $Database_pass="vcew@123";
		...
		function ExecuteQuery($sql) {
			//echo $sql;
			return $this->conn->query($sql) or die("Query Error" . $this->conn->connect_error);
		}
		...
		function GetResultsArray($sql) {
			//echo $sql."error";
			$result = $this->conn->query($sql) or die("Query Error" . $this->conn->connect_error);
			$resultarray = array ();
