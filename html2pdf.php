...
function __construct($orientation='P', $unit='mm', $format='A4')
{
    ...
    $this->issetcolor=false;
     ...
     $this->SetTextColor(133, 133, 134);
      $this->Cell(0,10,'Software Developed & Maintained by Software Development Cell / Vivekanandha College of Engineering Women',0,0,'C');
     $html = '<p></p>';
        ...
        if($i%2==0)
        {
            ...
            elseif($this->tdbegin) {
                ...
                elseif($this->ALIGN=='CENTER')
                    $this->Cell($this->tdwidth,$this->tdheight,$e,$this->tableborder,'','C');
                elseif($e=="&nbsp;") {
